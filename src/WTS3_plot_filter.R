...
# # outputファイル名
# args_output <- c("output/WTS3/normalize_1/all/SBD/ARI/tsne/filter_shift_plot/stim_cell/SampleNumber_4.png")
# # select data データの指定
# args_data <- c("normalize_1")
# # クラスター評価手法
# args_eval <- c("ARI")
...
# args_range <- c("all")
# # output yshift table
# args_output_table <- c("output/WTS3/normalize_1/all/SBD/ARI/tsne/filter_shift_table/stim_cell/SampleNumber_4.RData")
# # load yshift table
# args_load_table <- c("output/WTS3/normalize_1/all/SBD/ARI/tsne/shift_table/stim_cell/SampleNumber_4.RData")
