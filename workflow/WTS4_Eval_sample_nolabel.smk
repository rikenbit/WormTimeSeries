...
rule all:
    input: 
        expand('output/WTS4/normalize_1/{range}/{dist}/Eval_sample/{Eval}/k_Number_{N_cls}.RData',
            range=time_range,
            dist=dist_data,
            N_cls=N_CLUSTERS,
...
rule WTS4_Eval_sample_nolabel:
    ...
    output:
        eval_result = 'output/WTS4/normalize_1/{range}/{dist}/Eval_sample/{Eval}/k_Number_{N_cls}.RData'
    params:
    ...
    benchmark:
        'benchmarks/WTS4/normalize_1/{range}/{dist}/Eval_sample/{Eval}/k_Number_{N_cls}.txt'
    container:
        "docker://yamaken37/eval_sample:20220117"
    resources:
        mem_gb=200
    log:
        'logs/WTS4/normalize_1/{range}/{dist}/Eval_sample/{Eval}/k_Number_{N_cls}.log'
    shell:
