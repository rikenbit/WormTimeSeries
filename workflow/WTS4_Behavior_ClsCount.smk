...
rule all:
    input: 
        expand('output/WTS4/normalize_1/{range}/{dist}/ClsCount/k_Number_{N_cls}/df_count_all.RData',
            range=time_range,
            dist=dist_data,
            N_cls=N_CLUSTERS,
            ),
        expand('output/WTS4/normalize_1/{range}/{dist}/ClsCount/k_Number_{N_cls}/df_count_sum.RData',
            range=time_range,
            dist=dist_data,
            N_cls=N_CLUSTERS,
            )
...
rule WTS4_Behavior_ClsCount:
    ...
    output:
        count_all = 'output/WTS4/normalize_1/{range}/{dist}/ClsCount/k_Number_{N_cls}/df_count_all.RData',
    ...
    benchmark:
        'benchmarks/WTS4/normalize_1/{range}/{dist}/ClsCount/k_Number_{N_cls}/Behavior_ClsCount.txt'
    container:
        "docker://yamaken37/eval_sample:20220106"
    resources:
        mem_gb=200
    log:
        'logs/WTS4/normalize_1/{range}/{dist}/ClsCount/k_Number_{N_cls}/Behavior_ClsCount.log'
    shell:
