...
rule all:
    input:
        expand('output/WTS4/normalize_1/{range}/{dist}/DimReduc_MCMI/k_Number_{N_cls}/Eval_sample.png',
            range=time_range,
            dist=dist_data,
            N_cls=N_CLUSTERS
            )
...
rule WTS4_Eval_sample:
    ...
    benchmark:
        'benchmarks/WTS4/normalize_1/{range}/{dist}/DimReduc_MCMI/k_Number_{N_cls}/Eval_sample.txt'
    container:
