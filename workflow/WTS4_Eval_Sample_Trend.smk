...
rule all:
    input:
        expand('output/WTS4/normalize_1/{range}/{dist}/DimReduc_sample/k_Number_{N_cls}/Eval_Sample_trend.png',
            range=time_range,
            dist=dist_data,
            N_cls=N_CLUSTERS
            )
...
rule WTS4_Eval_Sample_Trend:
    ...
    output:
        'output/WTS4/normalize_1/{range}/{dist}/DimReduc_sample/k_Number_{N_cls}/Eval_Sample_trend.png'
    params:
        merged_label_path = 'data/WTS4_Eval_sample_fix.xlsx',
        input_path = 'output/WTS4/normalize_1/{range}/{dist}/Distance'
    benchmark:
        'benchmarks/WTS4/normalize_1/{range}/{dist}/DimReduc_sample/k_Number_{N_cls}/Eval_Sample_trend.txt'
    container:
        "docker://yamaken37/eval_sample:20220106"
    resources:
        mem_gb=200
    log:
        'logs/WTS4/normalize_1/{range}/{dist}/DimReduc_sample/k_Number_{N_cls}/Eval_Sample_trend.log'
    shell:
