...
rule all:
    input:
        expand('output/WTS4/normalize_1/{range}/{dist}/DimReduc_sample/k_Number_{N_cls}/{DR}/table.png',
            range=time_range,
            dist=dist_data,
            N_cls=N_CLUSTERS,
            DR=DimReduc
...
rule WTS4_DimReduc_sample:
    ...
    output:
        'output/WTS4/normalize_1/{range}/{dist}/DimReduc_sample/k_Number_{N_cls}/{DR}/table.png'
    params:
