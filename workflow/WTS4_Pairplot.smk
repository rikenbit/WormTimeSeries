...
rule WTS4_Pairplot:
    ...
    shell:
        'src/WTS4_Pairplot.sh {input.Merged_data} {input.Consistency} {input.No_of_cells} {input.Cluster}  {params.NL} {params.EL} {output.Cluster} {output.Neuron_type} {output.Class}>& {log}'