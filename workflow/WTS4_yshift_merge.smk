...
rule all:
    input:
        expand('output/WTS4/normalize_1/{range}/{dist}/{in_mat}M_{stat}/Sample_ALL.RData', 
            dist=dist_data,
            range=time_range,
            in_mat=input_matrix,
            stat=stat_value
...
rule WTS4_yshift_merge:
    output:
        'output/WTS4/normalize_1/{range}/{dist}/{in_mat}M_{stat}/Sample_ALL.RData'
    params:
        Shift_mat = 'output/WTS4/normalize_1/stimAfter/SBD_abs/{in_mat}'
    benchmark:
        'benchmarks/WTS4/normalize_1/{range}/{dist}/{in_mat}M_{stat}/Sample_ALL.txt'
    container:
