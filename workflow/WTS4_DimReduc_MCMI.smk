...
rule all:
    input:
        expand('output/WTS4/normalize_1/{range}/{dist}/DimReduc_{Re_cls}/k_Number_{N_cls}/{DR}/table.png',
            range=time_range,
            dist=dist_data,
            N_cls=N_CLUSTERS,
...
rule DimReduc_MCMI:
    ...
    output:
        'output/WTS4/normalize_1/{range}/{dist}/DimReduc_{Re_cls}/k_Number_{N_cls}/{DR}/table.png'
    params:
        NL = 'data/igraph/Fig1_HNS.RData',
        EL = 'data/WTS4_Eval_behavior_fix.xlsx'
    benchmark:
        'benchmarks/WTS4/normalize_1/{range}/{dist}/DimReduc_{Re_cls}/k_Number_{N_cls}/{DR}/table.txt'
    container:
        "docker://yamaken37/dimreduc_mcmi:20211224"
    resources:
        mem_gb=200
    log:
        'logs/WTS4/normalize_1/{range}/{dist}/DimReduc_{Re_cls}/k_Number_{N_cls}/{DR}/table.log'
    shell:
