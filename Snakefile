...
df_test = df_test[df_test['Data'].isin(['normalize_1']) & df_test['LAG'].isin(['600']) & ~df_test['SampleNumber'].isin(['3','8','20','25']) & df_test['CellType'].isin(['BAGL','BAGR','ASER','AWCL','AWCR','AWBL','ASEL','URXL','AWBR','ASHL','ASKR','ASHR','ASGR']) & df_test['ACF'].isin(['Acf']) & df_test['TF'].isin(['after'])]
paramspace = Paramspace(df_test, filename_params=['CellNumber', 'CellType'], param_sep="_")
### filter####
...
# LAG = list(map(str, range(1, 252, 10)))
# ### filter####
# TF = TF[0]
...
#     	expand('output/WTS2/heatmap/{D}/{T}/SampleNumber_{N}/new/τ{L}.png',
#     	 D=Data,
#     	 T=TF,
#     	 N=N_SAMPLES,
#     	 L=LAG)
...
#     	'output/WTS2/heatmap/{D}/{T}/SampleNumber_{N}/new/τ{L}.png'
#     benchmark:
...
#     	'output/WTS2/heatmap/normalize_1/all/SampleNumber_{N}/new/τ250_partial.gif'
#     benchmark:
